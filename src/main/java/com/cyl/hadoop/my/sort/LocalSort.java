package com.cyl.hadoop.my.sort;
...
public class LocalSort<K, V> extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job = new Job(conf, "sorter");
		job.setJarByClass(LocalSort.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new LocalSort(), args);
		System.exit(res);
	}
